<template>
  <v-ons-page modifier="white">
    <v-ons-list-title>Pages</v-ons-list-title>
    <v-ons-list>
      ...
      links: [
        {
          ...
          url: 'https://github.com/hermwong/'
        },
        {
          title: 'Code',
          icon: 'ion-code',
          url: 'https://github.com/hermwong/onsenui-vue-side-splitter-example'
        },
        {
          title: 'Twitter',
          icon: 'ion-social-twitter',
          url: 'https://twitter.com/hermwong'
        }
      ],
      access: [
        {
